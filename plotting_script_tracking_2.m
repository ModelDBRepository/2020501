...
figure(1)
subplot(my,mx,[1,5])
imagesc(tcrit1,(1:(N/10)),BD1',[0,30])
xlabel('Time (s)')
...
subplot(my,mx,[2,6])
imagesc(tcrit2,(1:(N/10)),BD2',[0,30])
xlabel('Time (s)')
ylabel('Neuron Index (Calcium Traces)')
set(gca,'Ydir','Normal')
title('Up-State')
...
subplot(my,mx,[3,7])
imagesc(tcrit3,(1:(N/10)),BD3',[0,30])
xlabel('Time (s)')
ylabel('Neuron Index (Calcium Traces)')
set(gca,'Ydir','Normal')
title('Return to HC')
...
subplot(my,mx,[9,13])
plot((1:kd)*T/kd,mean(REC2'),'LineWidth',2)
ylim([0,max(mean(REC2'))*1.1])
...
%% 
set(f1,'paperposition',[0,0,22,8])
print(f1,'tracking_2.png','-dpng','-r300')
print(f1,'tracking_2.svg','-dsvg','-painters')
