%% disinhibition model 2  
clear all
clc 
%close all
rng(2) %fix RNG just for refersion interneurons down the road (see documentation), user can change this otherwise.  
...
%% 
save disinhibition_model_2.mat -v7.3
